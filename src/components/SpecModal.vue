    ...
    <div class="sheet">
      <div class="top">
        ...
        <div>
          ...
          <div style="color:#f59e0b; font-size:13px;">⭐ {{ product.rate }} · 月销{{ product.sales }}</div>
        </div>
      </div>

      <div class="selector">
        <div style="font-weight:700;">规格选择</div>
      ...
      <div class="selector">
        <div style="font-weight:700;">添加小食</div>
      </div>
      <div class="addons">
      ...
      <div class="cta">
        <button class="button primary" @click="confirm">加入购物车 - ￥{{ sumPrice.toFixed(0) }}</button>
      </div>
    </div>
  </div>
</template>
